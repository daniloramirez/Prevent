...
namespace Prevent.Web.Migrations
{
    ...
    [Migration("20200524223752_AddUserEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Prevent.Web.Data.Entities.UserEntity", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Prevent.Web.Data.Entities.UserEntity")
                        .WithMany()
            ...
            modelBuilder.Entity("Prevent.Web.Data.Entities.PreventEntity", b =>
                {
                    ...
                    b.HasOne("Prevent.Web.Data.Entities.UserEntity", "User")
                        .WithMany("Prevents")
                        .HasForeignKey("UserId");
                });
